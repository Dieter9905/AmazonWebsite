...
<body onload="time()" class="app sidebar-mini rtl">
  ...
  <header class="app-header">
    ...
    <ul class="app-nav">
      ...
      <!-- User Menu-->
      <li><a class="app-nav__item" href="/amazon/signin.php"><i class='bx bx-log-out bx-rotate-180'></i> </a>
  ...
  <aside class="app-sidebar">
    <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="../assets/profile.jpg" width="50px"
        alt="User Image">
      <div>
        <p class="app-sidebar__user-name"><b><?php echo htmlspecialchars($userName); ?></b></p>
